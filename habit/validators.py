...
class TowFieldsValidator:
    ...
    def __call__(self, value):
        ...
        if val1 and val2:
            raise serializers.ValidationError("Может быть указано тольо одно из полей:"
...
class TimeCheckValidator:
    ...
    def __call__(self, value):
        ...
        if val1 > timedelta(seconds=120):
            raise serializers.ValidationError("Время на выполнение не может привышать 120сек ")
